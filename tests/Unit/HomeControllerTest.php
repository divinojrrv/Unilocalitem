...
class HomeControllerTest extends TestCase
{
    ...
    public function testRealizarConsulta_PubliPendeteSemCategoria()
    {
    ...
    public function testRealizarConsulta_PubbliPendente_SemBloco()
    {
    ...
    public function testRealizarConsulta_PubliPENDENTEADM()
    {
        ...
        session(['user_id' => 1,'user_tipousuario' => 1]); // Substitua pelo valor que deseja usar
