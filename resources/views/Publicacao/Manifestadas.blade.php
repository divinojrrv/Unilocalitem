...
<div class="container pt-4 " style="margin-left: 280px;">
    ...
    <div class="row justify-content-center">
        <div class="col-12">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row justify-content-end">
                                ...
                                <div class="form-group col-sm-12 col-md-6 mb-3 text-end"> 
                                    <button class="btn btn-primary" style="background-color: rgba(244, 7, 7, 1); outline: none;" type="button" onclick="cancelManifestation({{ $item->ID }})" >Cancelar</button>
                                    &nbsp
                                    <button class="btn btn-primary" style="background: rgba(8, 192, 26, 1); outline: none;" type="button" onclick="confirmManifestation({{ $item->ID }})" >Concluir</button>
                                </div>
            ...
            <script>
                function cancelManifestation(id) {

                    if (!confirm('Deseja realmente aceitar essa manifestação dessa publicação?')) {
                    ...
                    form.action = `{{ route('manifestar.recusar', ['id' => '/']) }}/${id}`;
                ...
                function confirmManifestation(id) {
                    ...
                    // Define o atributo "action" do formulário com a URL desejada, incluindo o valor de 'acao' e 'id'
                    form.action = `{{ route('manifestar.aceitar', ['id' => '/']) }}/${id}`;
